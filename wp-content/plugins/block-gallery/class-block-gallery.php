 ...
 * along with Block Gallery. If not, see <http://www.gnu.org/licenses/>.
 *
...
if ( ! class_exists( 'Block_Gallery' ) ) :
	...
	final class Block_Gallery {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheating huh?', 'block-gallery' ), '1.0' );
		}
		...
		public function load_textdomain() {
			load_plugin_textdomain( 'block-gallery', false, dirname( plugin_basename( BLOCKGALLERY_PLUGIN_DIR ) ) . '/languages/' );
		}
	}
endif;
