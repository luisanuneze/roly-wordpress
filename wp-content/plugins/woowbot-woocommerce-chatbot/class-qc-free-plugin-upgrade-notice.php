	...
	class QcPluginUpgradeToProNotice {
		...
		function hook_with_plugin_submenu()
		{
		   ...
		   else
		   {
			  ...
			  add_action( 'admin_menu' , array(&$this, 'func_qc_external_upgrade_link') );
		   }
		}
...
$instance_woowbot = new QcPluginUpgradeToProNotice();
...
if( is_admin() )
{
    ...
    $instance_woowbot->upgrade_link = "https://www.quantumcloud.com/products/woocommerce-chatbot-woowbot/";
    ...
    $instance_woowbot->plugin_slug = 'woowbot-woocommerce-chatbot'; //Plugin Slug. i.e. Folder Name
    $instance_woowbot->plugin_main_file = 'qcld-woowbot.php'; //Primary file of the pluign
    $instance_woowbot->plugin_menu_slug = 'woowbot'; //Main Menu Slug

    $instance_woowbot->show_with_action_links = true; //show in plugin.php page
    $instance_woowbot->show_with_meta_links = true; //show in plugin.php page
    $instance_woowbot->show_with_plugin_menu = true; //show inside parent menu of the plugin

    if( $instance_woowbot->check_if_plugin_page() )
    {
        $instance_woowbot->hook_with_plugin_action_links();
        $instance_woowbot->hook_with_plugin_meta_links();
    }

    $instance_woowbot->hook_with_plugin_submenu();
