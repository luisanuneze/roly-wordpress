<?php
/**
 * Photo Journal Theme Options Sanitization Functions
 *
 ...
 */
function photo_journal_sanitize_select( $input, $setting ) {
 ...
 */
function photo_journal_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function photo_journal_sanitize_post( $input ) {
 ...
 */
function photo_journal_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function photo_journal_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function photo_journal_sanitize_number_range( $number, $setting ) {
 ...
 * @return string
 */
function photo_journal_sanitize_date_time( $input ) {
