jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", abletoneCustomizerReset.confirm, abletoneCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                ...
                nonce: abletoneCustomizerReset.nonce.reset,
                section: o[1]
            };
