<?php
/**
 * Abletone Theme Options Sanitization Functions
 *
 * @package Abletone
 */
 ...
 */
function abletone_sanitize_select( $input, $setting ) {
 ...
 */
function abletone_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function abletone_sanitize_post( $input ) {
 ...
 */
function abletone_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Abletone 0.1
 */
function abletone_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function abletone_sanitize_number_range( $number, $setting ) {
