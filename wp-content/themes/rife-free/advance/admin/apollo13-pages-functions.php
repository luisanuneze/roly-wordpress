...
function apollo13framework_apollo13_recommendations() {
	...
	<div class="tools-grid">
		<div class="tool">
			<a href="<?php echo esc_url('https://shortpixel.com/'); ?>" title="<?php echo esc_html__( 'Shortpixel', 'rife-free' ); ?>"><img src="<?php echo esc_url( get_theme_file_uri( 'images/tools/shortpixel.png' ) ); ?>" alt="<?php echo esc_attr__( 'Shortpixel', 'rife-free' ); ?>" /></a>
		...
		<div class="tool">
			<a href="<?php echo esc_url('https://kinsta.com/'); ?>" title="<?php echo esc_html__( 'Kinsta', 'rife-free' ); ?>"><img src="<?php echo esc_url( get_theme_file_uri( 'images/tools/kinsta.png' ) ); ?>" alt="<?php echo esc_attr__( 'Kinsta', 'rife-free' ); ?>" /></a>
		...
		<div class="tool">
			<a href="<?php echo esc_url('https://wordpress.org/plugins/autoptimize/'); ?>" title="<?php echo esc_html__( 'Autoptimize', 'rife-free' ); ?>"><img src="<?php echo esc_url( get_theme_file_uri( 'images/tools/autoptimize.png' ) ); ?>" alt="<?php echo esc_attr__( 'Autoptimize', 'rife-free' ); ?>" /></a>
		...
		<div class="tool">
			<a href="<?php echo esc_url('https://wpml.org/'); ?>" title="<?php echo esc_html__( 'WPML', 'rife-free' ); ?>"><img src="<?php echo esc_url( get_theme_file_uri( 'images/tools/_wpml.png' ) ); ?>" alt="<?php echo esc_attr__( 'WPML', 'rife-free' ); ?>" /></a>
		...
		<div class="tool">
			<a href="<?php echo esc_url('https://elementor.com/pro/'); ?>" title="<?php echo esc_html__( 'Elementor Pro', 'rife-free' ); ?>"><img src="<?php echo esc_url( get_theme_file_uri( 'images/tools/elementor.png' ) ); ?>" alt="<?php echo esc_attr__( 'Elementor Pro', 'rife-free' ); ?>" /></a>
		...
		<div class="tool">
			<a href="<?php echo esc_url('https://apollo13themes.com/rife-elementor-extensions/'); ?>" title="<?php echo esc_html__( 'Rife Elementor Extensions &amp; Templates', 'rife-free' ); ?>"><img src="<?php echo esc_url( get_theme_file_uri( 'images/tools/_rife.png' ) ); ?>" alt="<?php echo esc_attr__( 'Rife Elementor Extensions &amp; Templates', 'rife-free' ); ?>" /></a>
